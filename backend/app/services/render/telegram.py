...
def render_digest(
    ...
    *,
    ...
    if bills > 0:
        ...
        # 말로도 읽힌다. "신규 법안인지 헷갈린다" 는 말을 들었다.
        #
        # "새로 발의된" 이라고 쓰려다 말았다. 국회 목록에는 며칠 늦게
        # 올라오는 건이 있어서 — 8월 14일 발의된 것을 22일에 알았다 —
        # 발의일과 우리가 안 날이 다르다. 우리가 아는 것은 "오늘 처음
        # 봤다" 까지이고, 그것만 말한다.
        lines.append(
            f"오늘 새로 확인된 세법 개정안이 {bills}건 있습니다 (아직 법이 아닙니다)."
        )
