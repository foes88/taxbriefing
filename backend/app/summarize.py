...
KINDS_WITHOUT_AI = frozenset(
    {
        ...
        #     처리결과: 심사 중
        #
        # 조문이 없다. 그런데 86건에 돌렸고, 나온 것은 전부 빈 껍데기였다.
        #
        #     changes []  affected_users []  business_impact []
        #     required_actions []
        #     needs_expert: "법률안 내용이 구체적으로 제시되지 않아…"
        #
        # 그리고 한 줄 요약은 이렇게 덮였다.
        #
        #     조세특례제한법 일부개정법률안이 국회에 발의되어 심사 중이며,
        #     구체적인 내용이 확정되지 않아 사업자에게 직접적인 변화는 없습니다.
        #
        # **내용은 확정돼 있다.** 우리가 조문을 안 가지고 있을 뿐이고, 그건
        # 모델이 알 수 없는 사정이다. 아무것도 못 얻으면서 하루치 토큰의
        # 두 배를 태웠고, bulk_draft 가 써 둔 정직한 문구까지 지웠다.
        #
        #     국회 발의 법안 · 문진석의원 등 12인 · 2026년 8월 21일 발의.
        #     재정경제기획위원회 심사 중이며 통과 여부는 정해지지 않았습니다.
