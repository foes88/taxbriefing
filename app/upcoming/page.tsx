    ...
    <div className="min-h-screen pb-20">
      ...
      <main className="mx-auto max-w-page px-4">
        <section className="pb-4 pt-5">
          <p className="text-meta font-semibold text-ink-3">앞으로 바뀝니다</p>
          <h1 className="mt-1 text-display text-ink">
            시행 예정 {feed?.total ?? items.length}건
          </h1>
        </section>
        ...
        */}
        <div className="card mb-6 border-l-4 border-warn px-4 py-3.5">
        ...
        {error ? (
          ...
          BUCKETS.map((bucket) => {
            ...
            return (
              <section key={bucket.key} className="pt-7 first:pt-0">
